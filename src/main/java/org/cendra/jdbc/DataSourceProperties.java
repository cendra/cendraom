...
public class DataSourceProperties {
	...
	public String toString() {
		return "DataSourceProperties [driverClassName=" + driverClassName
				+ ", initialSize=" + initialSize + ", maxActive=" + maxActive
				+ ", maxIdle=" + maxIdle + ", validationQuery="
				+ validationQuery + ", url=" + url + ", userName=" + userName
				+ ", userPassword=" + userPassword + ", verbose=" + verbose
				+ "]";
	}
