...
class CreateClassBO {
	...
	public XTypeX create() throws Exception {

		XTypeX classComponent = new XClazzX();
	...
	public XTypeX create(XTypeX clazz) throws Exception {
	...
	private boolean checkClass(String operation, XTypeX clazz, String msg)
			throws Exception {
...
//			checkExtendsClass(operation, clazz, clazz.getExtendsClass());
//		}

		for (XAttributeX e : clazz.getAtts()) {
	...
	private void checkExtendsClass(String operation, XTypeX clazz,
			XTypeX extendsClazz) throws Exception {
...
//			if (clazz.getExtendsClass().getName().equals(extendsClazz.getName())) {
//				if (c >= 1) {
//					throw new IllegalArgumentException(
//							operation
...
//		}
	...
	private void checkClassAtt(String operation, XTypeX clazz, XAttributeX clazzAtt)
			throws Exception {
	...
	private boolean checkUsableClass(String operation, XTypeX clazz, String msg)
			throws Exception {
